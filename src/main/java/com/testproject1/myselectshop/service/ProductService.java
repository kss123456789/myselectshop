...
import com.testproject1.myselectshop.dto.ProductMypriceRequestDto;
import com.testproject1.myselectshop.dto.ProductRequestDto;
import com.testproject1.myselectshop.dto.ProductResponseDto;
import com.testproject1.myselectshop.entity.*;
import com.testproject1.myselectshop.naver.dto.ItemDto;
import com.testproject1.myselectshop.repository.FolderRepository;
import com.testproject1.myselectshop.repository.ProductFolderRepository;
...
public class ProductService {
    ...
    public ProductResponseDto updateProduct(Long id, ProductMypriceRequestDto requestDto, User user) {
        ...
        if (!productUser.getId().equals(user.getId())) {
            throw new IllegalArgumentException("등록한 사용자가 아닙니다.");
        }
